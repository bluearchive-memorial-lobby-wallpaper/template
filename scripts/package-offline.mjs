...
//
// When scaffolding a new wallpaper project, replace the SLUG placeholder
// with the publicSlug from the project identity contract and set the
// package version to `1.0.0`.
import { createOfflinePackage } from "ba-memorial-lobby-wallpaper-toolkit";
import { readFile } from "node:fs/promises";
import { resolve } from "node:path";

const SLUG = "my-character"; // identity contract publicSlug; keep in sync
